...
<head>
    ...
    <title>Create Batch Admin Account - Edulk</title>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="card mb-2">
                                <div class="card-body">
                                    <div class="pt-4 pb-2">
                                        <h5 class="card-title text-center pb-0 fs-4">Create an Representer Account</h5>
                                        <!-- <p class="text-center small">Enter your username & password to login</p> -->
                                    </div>

                                    <form action="register3.php" method="POST" class="row g-3 needs-validation" novalidate>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#signup-form").submit(function(event) {
                ...
                $.ajax({
                    url: "register3.php", // Send form data to register.php
                    type: "POST",
