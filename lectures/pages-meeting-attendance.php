...
if ($meetingDetails) {
    $meetingStart = strtotime($meetingDetails['date'] . ' ' . $meetingDetails['start_time']);
    $lateThreshold = $meetingStart + (30 * 60); // 30 minutes after start
}

foreach ($attendance as &$record) {
    $logTime = strtotime($record['logtime']);
