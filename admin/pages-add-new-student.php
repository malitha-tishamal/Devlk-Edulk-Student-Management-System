...
<head>
    ...
    <title>Add Student - Eduwlk</title>
    ...
    <?php if (isset($_SESSION['status'])): ?>
        ...
        <script>
            ...
            <?php if ($_SESSION['status'] == 'success'): ?>
                setTimeout(function() {
                    window.location.href = 'pages-add-new-student.php'; // Redirect after 10 seconds
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body pt-4">
                            ...
                            <form action="admin-register-process4.php" method="POST" class="needs-validation" novalidate>
                                ...
                                <div class="row mb-3">
                                    <label for="email" class="col-lg-3 col-md-4 col-sm-4 col-form-label">Reg No</label>
                                    <div class="col-lg-9 col-md-8 col-sm-8">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-9 col-md-8 col-sm-8">
                                        <div class="input-group">
                                            <span class="input-group-text">+94</span>
                                            <input type="tel" class="form-control" id="mobileNumber" name="mobile" placeholder="412345678" oninput="validateMobile(this)" required>
                                            <div class="invalid-feedback" style="font-size:14px;" id="numberErrorMessage">
                                                Please enter the mobile number
                                            </div>
                                        </div>
                                ...
                                <div class="row mb-3">
                                    <label for="email" class="col-lg-3 col-md-4 col-sm-4 col-form-label">Address</label>
                                    <div class="col-lg-9 col-md-8 col-sm-8">
                                ...
                                <div class="row mb-3">
                                    <label for="email" class="col-lg-3 col-md-4 col-sm-4 col-form-label">Now Status Comming </label>
                                    <div class="col-lg-9 col-md-8 col-sm-8">
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#signup-form").submit(function(event) {
                ...
                $.ajax({
                    url: "admin-register-process4.php", // Send form data to register.php
                    type: "POST",
                    ...
                    success: function(response) {
                        ...
                        if (response.status === "success") {
                            setTimeout(function() {
                                window.location.href = "add-batchadmin.php"; // Change this to your target redirect URL
